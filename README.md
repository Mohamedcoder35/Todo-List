...
- **Add New Task**: Easily add taskes to your list.
- **Edit Tasks**: Update existing task content.
- **Delete Tasks**: Remove tasks from the list.
- **Mark as Complete**: Toggle task completion status.
- **Save to Local Storage**: Automatically save to Local Storage.
